...
const analysisOfRequirements = "The goal of analysis is to determine where the problem is, in an attempt to fix the system.";
const design = "It functions and operations are described in detail, including screen layouts, business rules, process diagrams, and other documentation.";
const implementation = "This is the stage where actual coding begins. The main focus of the phase is the development of perfect codes by the developers.";
const testingAndIntegration = "In this stage, all variants of the functional testing such as integration testing, unit testing, system testing, acceptance testing, and non-functional testing are done.";
const maintain = "Once the customers start using well-developed software, the actual issues start surfacing with time. This doesn’t mean that the software will get corrupted. However, it might require occasional issues surfacing time and again. This particular process is termed as maintenance for the finalized product or software.";
